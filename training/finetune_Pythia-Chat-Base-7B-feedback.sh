...
export MODEL_NAME=Pythia-Chat-Base-7B-feedback

CKPT_LOAD_PATH=${DIR}/../model_ckpts/Pythia-Chat-Base-7B
CKPT_SAVE_PATH=${DIR}/../model_ckpts/${MODEL_NAME}
...
${DIR}/../data/OIG/contributions/together_user_feedback_v0.2.jsonl:5.0 \
"
...
--task-name \
"${DATASETS}" \
--checkpoint-load-path ${CKPT_LOAD_PATH} \
--checkpoint-path ${CKPT_SAVE_PATH} \
--init-steps true \
